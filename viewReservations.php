...
<head>
  ...
  <title>Travel Kenya | Reservations</title>
  <meta charset="utf-8">
	...
	while(($row = mysqli_fetch_row($result))!=null)
	{
		...
		if($returnInstanceId!=null)
		{
			...
			if (mysqli_num_rows($result1)>0)
			{
				...
				{
				  echo("<strong>Flight: $row1[0] This flight has been cancelled. Please contact Travel Kenya for further information</strong>");
				}
				else
				{
