...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60" class="shortPage" style="background-color:green">
...
<h1>Success </h1>
  <?php
	echo("Your booking was successful!<br>");
  echo("Check your email $youremail");
  ?>
 </div> 
