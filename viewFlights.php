...
<head>
  ...
  <title>Travel Kenya - The easiest way to fly</title>
  <meta charset="utf-8">
  ...
  <div class="container">
    <div class="navbar-header">
      <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
       ...
       <a class="navbar-brand" href="home.html"><img src="img/logo1.jpeg" alt="JustFly"/></a>
    </div>
...
<form action="viewFlights.php" method="POST" class="form" role="form">
<div class="container">
...
<div id="services" class="container-fluid text-center">
 <?php
  if(isset($_POST['optradio']))
  {
	...
	{
		if(strcmp($_POST['optradio'],"oneway")==0)
		{
			echo("<h2>Flights</h2>");
		}
		else if(strcmp($_POST['optradio'],"roundtrip")==0)
		{	
	...
	if(strcmp($_POST['optradio'], "roundtrip")==0)
	{
		echo("</br>");
...
$('#bookFlights').click(function post(path, parameters) {
    ...
    form.attr("action", "passengerInfo.php");
