...
$link = mysqli_connect('localhost', 'root', '', 'airlineData');
...
{
	$sql6 = "SELECT Availability FROM available_seats WHERE InstanceId = '$returnInstance' AND CategoryId = '$category';";	
	$result6 = mysqli_query($link,$sql6);
	$availability = 0;
	if (mysqli_num_rows($result6)>0)
				{
...
//$sql5 = "INSERT INTO seats_reservation(Seat_no, ReservationId) values ('$Seat_no', '$ReservationId');";
//$result2 = mysqli_query($link,$sql5);
//$sql9 = "INSERT INTO passenger(PassengerId, Passenger_Name, Passenger_Age, Meal_Preference) values ('$passengerId', '$fname', '$yourAge', '$mealpref');";
//$result3 = mysqli_query($link,$sql9);
//If successful, go to viewReservations
$sql10 = "INSERT INTO booked(email, name, class) values ('$youremail', '$fname', '$returnInstance');";
$result8 = mysqli_query($link,$sql10);
header("Location: bookingSuccess.php");
echo('Your seat no is $Seat_n0');
?>