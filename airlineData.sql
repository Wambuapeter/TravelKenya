...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1340947371ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=airlineData&table=booked">`airlineData`.`booked`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=airlineData&table=airport">`airlineData`.`airport`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=airlineData&table=flight">`airlineData`.`flight`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=airlineData&table=flight_instance">`airlineData`.`flight_instance`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=airlineData&table=available_seats">`airlineData`.`available_seats`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=airlineData&table=reservation">`airlineData`.`reservation`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=airlineData&table=seats_reservation">`airlineData`.`seats_reservation`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=airlineData&table=passenger">`airlineData`.`passenger`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=airlineData&table=seats">`airlineData`.`seats`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=airlineData&table=passenger_reservation">`airlineData`.`passenger_reservation`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="54272e746f675d696b2737765b3f232c">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="airlineData" targettable="flight">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `flight`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="airlineData" targettable="flight_instance">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `flight_instance`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="airlineData" targettable="flight">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `flight`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="airlineData" targettable="airport">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `airport`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="airlineData" targettable="reservation">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `reservation`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="airlineData" targettable="flight_instance">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `flight`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="airlineData" targettable="available_seats">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `available_seats`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="airlineData" targettable="flight">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `airport`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="airlineData" targettable="booked">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `booked`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="airlineData" targettable="booked">
                            <div class="action_content">
